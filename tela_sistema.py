...
class TelaSistema(AbstractTela):
    ...
    def init_components(self):
        ...
        sg.set_options(font=font, background_color= '#FA91BA')
        layout = [
            [sg.Text('Tela Principal: Controle de Filiais', background_color= '#FA91BA')],
            [sg.Text('O que deseja fazer?', background_color= '#FA91BA')],
            [sg.Button('Adicionar uma filial', key=1, size=(30, 1), button_color= '#FF4A91')],
            [sg.Button('Excluir uma filial', key=2, size=(30, 1), button_color= '#FF4A91')],
            [sg.Button('Modificar uma filial', key=3, size=(30, 1), button_color= '#FF4A91')],
            [sg.Button('Listar filiais', key=4, size=(30, 1), button_color= '#FF4A91')],
            [sg.Button('Sair', key=0, size=(30, 1), button_color= '#FF4A91')]
        ]    
