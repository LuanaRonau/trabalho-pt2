...
class ControladorGerenteEsp(ControladorFuncionario):
    ...
    def demitir(self):
        ...
        gerente = self.__controlador_filial.filial.gerente
        self.__controlador_contrato.demitir(gerente)
    ...
    def listar_contratos(self):
        ...
        if len(self.__gerente.contratos) > 0:
            ...
            self.__tela_gerente.listagem(f'Listagem de contratos por {self.__gerente.nome}', lista)
        else:
